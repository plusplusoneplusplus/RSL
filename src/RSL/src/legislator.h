...
namespace RSLibImpl
{
    ...
    // s_PageSize, s_SystemPageSize, PAGES_PER_WRITE, RoundUpToPage and
    // RoundUpToSystemPage now live in logfile.h (included above) alongside the
    // page-aligned unbuffered IO code that defines their meaning.
    ...
    // LogFile now lives in logfile.h (included above).
